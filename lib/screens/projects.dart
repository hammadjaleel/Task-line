...
class _ProjectsScreenState extends State<ProjectsScreen> {
  String _teamSummary(Map<String, dynamic> project) {
    ...
    if (team.isEmpty) {
      final owner = project['owner'] as Map<String, dynamic>? ?? {};
      return owner['name'] as String? ?? 'Owner pending';
    }
    final names = team
  ...
  Widget build(BuildContext context) {
    ...
    final projectprovider = Provider.of<Listallprojectsprovider>(
      context,
      listen: false,
    );
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        final totalProjects = snapshot.data!.totalprojects;
